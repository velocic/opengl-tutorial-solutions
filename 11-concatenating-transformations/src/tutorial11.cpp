...
int main()
{
    ...
    SDL_Window* window = SDL_CreateWindow(
        "ogldev.atspace.co.uk Tutorial 11 -- Concatenating Transformations",
    ...
    while (userRequestedExit == false)
    {
        ...
        translationMatrix = glm::translate(glm::mat4(), glm::vec3(sinf(scale * 2), 0, 0));

        worldPosition = translationMatrix * rotationMatrix * scaleMatrix;
